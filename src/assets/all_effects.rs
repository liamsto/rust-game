...
lazy_static! {
    pub static ref POISON: Mutex<Effect> = Effect::new("Poison", "Poison deals damage and reduces defense while active.", 5, Arc::new(|on: &mut dyn Combatant| {
    ...
    pub static ref BURN: Mutex<Effect> = Effect::new("Burn", "Burn deals damage while active.", 5, Arc::new(|on: &mut dyn Combatant| {
